...
import { Calendar, Video, Users, Link, ChevronLeft, ChevronRight, Info, MessageSquare, Settings, Play, Shield, Clock, Menu, X, PlusCircle } from 'lucide-react';
...
export default function EzMeetPlatform() {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: "Schedule meetings in your calendar and send invitations to participants",
    ...
    },
    {
      ...
      description: "Share screens, use chat, and collaborate on documents in real-time",
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-1 flex-col md:flex-row md:items-center px-4 py-8 md:py-12 max-w-7xl mx-auto w-full">
        ...
        <div className="md:w-1/2 flex flex-col justify-center pr-0 md:pr-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-3 text-gray-800">Video calls and meetings for everyone</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            ...
            <div className="flex-1 flex items-center border rounded-lg overflow-hidden bg-white focus-within:ring-2 focus-within:ring-blue-400 focus-within:border-blue-400 transition duration-150">
              ...
              />
              <button 
                className={`px-6 py-3 font-medium ${meetingCode ? 'text-blue-600 hover:bg-blue-50' : 'text-gray-400 cursor-not-allowed'}`}
          ...
          {recentMeetings.length > 0 && (
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-500 mb-3">RECENT MEETINGS</h3>
              <div className="space-y-2">
                {recentMeetings.map(meeting => (
                  <div key={meeting.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition duration-150">
                    <div className="flex items-center">
          ...
          <a href="#learn-more" className="text-blue-600 hover:text-blue-800 text-sm group flex items-center">
            <span className="underline-offset-2 group-hover:underline">Learn more about Ez Meet</span>
        ...
        <div className="md:w-1/2 flex items-center justify-center mt-10 md:mt-0">
          <div className="relative w-full max-w-md">
            ...
            <button 
              ...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 -ml-4 z-10 bg-white rounded-full p-2 shadow-md hover:bg-gray-100 transition duration-150"
            ...
            <div className="bg-white rounded-xl p-8 text-center shadow-lg">
              <div className="mb-6">
                <div className="mx-auto w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center shadow-md">
            ...
            <button 
              ...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 -mr-4 z-10 bg-white rounded-full p-2 shadow-md hover:bg-gray-100 transition duration-150"
